...
class AdsInfo extends StatelessWidget {
  const AdsInfo({super.key});

  @override
  Widget build(BuildContext context) {
    AdsInfoController adsInfoController = Get.put(AdsInfoController());
    HomeController homeontroller = Get.put(HomeController());
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              appBarAdsInfo(
                  () {
                    homeontroller.goToHomeWithIndex(1, {});
                  },
                  S.of(context).unitDetails,
                  () {
                    //onPressReport
                    Get.to(() => const Report(),
                        arguments: {"adsId": adsInfoController.adsModel!.id},
              ...
              GetBuilder<FavouriteController>(
                builder: (controller) => imageWithIconFavO(() {
                  if (controller.isFav[
                              adsInfoController.adsModel!.id.toString()] ==
                          "0" ||
                      controller.isFav[
                              adsInfoController.adsModel!.id.toString()] ==
                          null) {
                    controller.setFavourite(
                        adsInfoController.adsModel!.id.toString(), "1");
                    controller.addFavouriteItems(
                        context, adsInfoController.adsModel!.id.toString());
                  } else {
                    controller.setFavourite(
                        adsInfoController.adsModel!.id.toString(), "0");
                    controller.removeFavouriteItems(
                        context, adsInfoController.adsModel!.id.toString());
                  }
                },
                    adsInfoController.adsModel!.productImage == ""
                        ? const AssetImage(ImagesLink.splashLogoImage)
                        : NetworkImage(
                            adsInfoController.adsModel!.productImage!),
                    controller
                        .isFav[adsInfoController.adsModel!.id.toString()]),
              ),
              infoAds(
                  adsInfoController.adsModel!.name,
                  "${adsInfoController.adsModel!.cityName ?? S.of(context).notMark} , ${adsInfoController.adsModel!.areaName ?? S.of(context).notMark}",
                  "${adsInfoController.adsModel!.price}",
                  adsInfoController.adsModel!.priceType == "per_month"
                      ? "month"
                      : "year",
                  "${adsInfoController.adsModel!.width ?? 0} ${S.of(context).m2}",
                  "${adsInfoController.adsModel!.bathroomsNo ?? 0} ${S.of(context).bathroom}",
                  "${adsInfoController.adsModel!.bedroomsNo ?? 0} ${S.of(context).room}"),
              if (adsInfoController.adsModel!.description != null &&
                  adsInfoController.adsModel!.description != "null" &&
                  adsInfoController.adsModel!.description != "" &&
                  adsInfoController.adsModel!.description != "<p>	</p>")
                discriptionAds(
                    //   adsInfoController.adsModel!.description,
                    adsInfoController.htmlData,
                    adsInfoController.adsModel!.imgaes!.isEmpty ? false : true,
                    adsInfoController.adsModel!.imgaes!.isEmpty
                        ? const SizedBox()
                        : SizedBox(
              ...
              detailesAds(
                  adsInfoController.adsModel!.categoryName ??
                      S.of(context).notMark,
                  "${adsInfoController.adsModel!.bathroomsNo ?? 0}",
                  "${adsInfoController.adsModel!.bedroomsNo ?? 0} ",
                  "${adsInfoController.adsModel!.streetWidth ?? 0}",
                  adsInfoController.adsModel!.yearBuilt ??
                      S.of(context).notMark,
                  adsInfoController.adsModel!.facade ?? S.of(context).notMark,
                  "${adsInfoController.adsModel!.price}",
                  adsInfoController.adsModel!.priceType == "per_month"
                      ? "month"
                      : "year", () {
                Get.to(
                    () => AdsOrder(
                          yearlyRent: adsInfoController.adsModel!.priceType ==
                                  "per_year"
                              ? adsInfoController.adsModel!.price.toString()
                              : ((adsInfoController.adsModel!.price!) * 12)
                                  .toString(),
                          adsId: adsInfoController.adsModel!.id.toString(),
                          priceAds: adsInfoController.adsModel!.price!,
                        ),
                    arguments: {
                      "price": adsInfoController.adsModel!.price.toString()
                    },
                    transition: Transition.leftToRightWithFade,
                    duration: const Duration(milliseconds: 800));
              }),
              mapWidget(),
              statusWidget(adsInfoController.adsModel!.status == "show"
                  ? S.of(context).active
              ...
              if (adsInfoController.adsModel!.productSpecificationData != null)
                companyInfo(
                    adsInfoController.adsModel!.productSpecificationData!.companyName ??
                        adsInfoController
                            .adsModel!.productSpecificationData!.addedByName,
                    adsInfoController
                        .adsModel!.productSpecificationData!.addedByMobile,
                    adsInfoController
                        .adsModel!.productSpecificationData!.adNumber,
                    adsInfoController
                        .adsModel!.productSpecificationData!.valLicenseNumber),
              SizedBox(
                height: 5.h,
              ),
            ],
